...
namespace PersistenceLayer
{
    public class WebStorageContext : IdentityDbContext<User, IdentityRole<int>, int>
    {
        ...
        public DbSet<ModelLibrary.Models.File> Files { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ModelLibrary.Models.File>().ToTable("Files");
            ...
            modelBuilder.Entity<ModelLibrary.Models.File>()
